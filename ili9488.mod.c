...
MODULE_ALIAS("spi:sx035hv006");
MODULE_ALIAS("of:N*T*Cmakerlab,sx035hv006");
MODULE_ALIAS("of:N*T*Cmakerlab,sx035hv006C*");

MODULE_INFO(srcversion, "7303A08DA52896402B86F93");
